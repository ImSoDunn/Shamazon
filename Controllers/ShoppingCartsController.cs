...
namespace Shamazon.Controllers
{
    public class ShoppingCartsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ItemName,ItemDescription,ItemPrice,ItemQuantity")] ShoppingCart shoppingCart)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ItemName,ItemDescription,ItemPrice,ItemQuantity")] ShoppingCart shoppingCart)
        {
